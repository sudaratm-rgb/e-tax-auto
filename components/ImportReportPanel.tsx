 ...
 * ในเซสชันนี้ ไม่มีจริง ๆ) แถวที่จะเลือกส่งได้ต้องผ่านการตรวจสอบ contact เหมือนตารางหลักทุก
 * ประการก่อนเสมอ (เช็คจากฝั่ง server ด้วย buildRow ตัวเดียวกัน, ไม่เช็ค journal — ดู README)
 * กันส่งใบข้อมูลไม่ครบ/ผิดผ่านทางลัดนี้ไปได้ — ใช้ /api/send-etax เส้นทางเดียวกับตารางหลักตอนกดส่งจริง
 *
            ...
            <div style={{ padding: 18 }}>
              {loading && (
                <div className="notice">
                  <Icon.Refresh size={14} className="spin" /> กำลังอ่านไฟล์ + ตรวจสอบข้อมูล contact ของทุกใบที่รอส่ง...
                </div>
              )}
              {polling && (
